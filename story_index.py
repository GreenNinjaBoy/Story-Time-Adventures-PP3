...
def end_game_2(user_name):
    ...
    print_slow(f"inspiring generations of explorers to venture into the unknown.")
    print_slow(f"They became a hero, not just for Earth but for the entire galaxy,")
    ...
    print_slow(f"And so, the tale of {user_name}'s Cosmic Space Adventure echoed through the universe,")
    print_slow(f"reminding everyone that the stars were not just distant lights,")
...
def create_pages_2(user_name):
    ...
    sa_page_9 = Page(
        message=f"Curious about the space station, {user_name} decided to teleport there first. Upon arrival, they met lots of different space explorers. Among them was a wise alien scholar who had a unique crystal that could power up {user_name} spaceship.",
        message_2=f"How should {user_name} use the alien crystal?",
        choices=["1. Use the crystal to fix the spaceship's engine for faster travel.", "2. Harness the crystal's energy to talk to more aliens."],
    ...
    sa_page_7 = Page(
        ...
        choices=["1. A lush, alien jungle planet. ", "2. A bustling space station filled with intergalactic travelers."],
    ...
    sa_page_5 = Page(
        ...
        choices=["1. Journey through the dangerous asteroid field", "2. Brave the cosmic storm in a high-speed space pod"],
    ...
    sa_page_3 = Page(
        ...
        choices=["1. Use a space ray to create a safe passage", "2. Find an alternate route through the outpost."],
    ...
    return sa_page_1, sa_page_2, sa_page_3, sa_page_4, sa_page_6, sa_page_7, sa_page_8, sa_page_9, sa_page_10, sa_page_11